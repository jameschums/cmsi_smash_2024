...
!      if (edft /=0) then
!        write(*,'("energies dft ",i3,2x,f14.7," hartrees escsmp2")')jamesflag,(edft)
!      endif
      ...
      if (jamesflag >= 1 .and. escsmp2 /=0) then
        write(13, '(I3)')natom
!       write(12, '("   ")')
      ...
      elseif (jamesflag >= 1 .and. escf /=0) then
        write(13, '(I3)')natom
!       write(12, '("   ")')
        write(13, '(f14.7)')(escf)
        do i= 1,natom
...
! ----   
      if(master) then
        write(*,'("james writegeom.F90 line 49 = ",i3," so far, hope it never prints zero ")')jamesflag
        write(*,'(" ----------------------------------------------------")')
